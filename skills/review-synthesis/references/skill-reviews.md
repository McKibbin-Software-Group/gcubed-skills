...
Choose the lenses that fit the change. Always include the instruction coherence and feel lens. For multi-reviewer work, keep each reviewer narrow.
...
- Moderate: bloated `SKILL.md`, missing guardrails, unclear user-confirmation rules, duplicated canonical guidance, stale asset references, unresolved instruction tension, or validation gaps.
...
## Suggested Reviewer Perspectives
...
Always keep instruction coherence and feel represented, either in the parent synthesis or as a dedicated reviewer for complex documents.
