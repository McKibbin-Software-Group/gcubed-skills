...
- Primary consumer install path: `npx skills@latest add McKibbin-Software-Group/gcubed-skills`.
- Install one skill explicitly: `npx skills@latest add McKibbin-Software-Group/gcubed-skills --skill <skill-name>`.
- Install the whole collection intentionally: `npx skills@latest add McKibbin-Software-Group/gcubed-skills --skill '*'`.
