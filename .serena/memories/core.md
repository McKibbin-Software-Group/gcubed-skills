...
- Distribution repo for portable Codex-compatible skills around McKibbin Software Group's G-Cubed development workflow, MSG Architect methodology, repo memory, skill capture, review synthesis, and behavior-preserving cleanup.
...
- Current distributed skills: `setup-gcubed-skills`, `project-memory`, `skill-capture`, `review-synthesis`, `code-structure-cleanup`.
